...
;(function($) {
  ...
  stuffingInfo.defaults = $.extend({}, $.fn.editabletypes.select.defaults, {
    ...
    <div class="editable-form">
        <label class="col-sm-3 control-label">Stuffing Place:</label>
        <div class="col-sm-8">
            <input class="form-control type="text" id="place">
        </div>
    </div>
    <div class="editable-form">
        <label class="col-sm-3 control-label">Stuffing Date:</label>
        <div class="col-sm-8">
            <input class="form-control type="text" id="date">
        </div>
    </div>
    <div class="editable-form">
        <label class="col-sm-3 control-label">Stuffing requirement
        :</label>
        <div class="col-sm-8">
