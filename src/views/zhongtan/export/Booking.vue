                ...
                <div class="row row-udline">
                  <div class="col-md-6 form-horizontal">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input
                          v-model="workRow.billloading_loading_port"
                          class="form-control"
                          data-parsley-required="true"
                          maxlength="50"
                          data-parsley-maxlength="50"
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input
                          v-model="workRow.billloading_discharge_port"
                          class="form-control"
                          data-parsley-required="true"
                          maxlength="50"
                          data-parsley-maxlength="50"
