...
const routes = [
  ...
  { path: '/admin/zhongtan/configuration/BankInfoConfig', component: resolve => require(['@/views/zhongtan/configuration/BankInfoConfig'], resolve) },
  ...
  { path: '/admin/zhongtan/fee/InvoiceDefaultFee', component: resolve => require(['@/views/zhongtan/fee/InvoiceDefaultFee'], resolve) },
  { path: '/admin/zhongtan/fee/CustomerFixedDeposit', component: resolve => require(['@/views/zhongtan/fee/CustomerFixedDeposit'], resolve) },
  { path: '/admin/zhongtan/fee/CustomerFixedReceipt', component: resolve => require(['@/views/zhongtan/fee/CustomerFixedReceipt'], resolve) },
  { path: '/admin/zhongtan/fee/ExportFeeData', component: resolve => require(['@/views/zhongtan/fee/ExportFeeData'], resolve) },
